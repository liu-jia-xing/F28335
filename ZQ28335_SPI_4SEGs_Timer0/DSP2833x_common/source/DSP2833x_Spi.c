...
// 查F28335引脚表，只有SPI模块，但可以由两组引脚，是否可以同时使用，没有验证
//SPI_A引脚：GPIO16---SPISIMOA;GPIO17---SPISOMIA;
//         GPIO18---SPICLKA; GPIO19---SPISTEA(L有效);

//SPI_A引脚：GPIO54---SPISIMOA;GPIO55---SPISOMIA;
//         GPIO56---SPICLKA; GPIO57---SPISTEA(L有效);
